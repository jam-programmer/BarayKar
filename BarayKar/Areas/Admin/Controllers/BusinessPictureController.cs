...
using Application.Cqrs.BusinessPicture;
...
namespace BarayKar.Areas.Admin.Controllers
{
    ...
    public class BusinessPictureController(IMediator mediator) : Controller
    {
        ...
        {
            var pageModel = await _mediator.Send(new GetBusinessPicturesQuery
        ...
        [HttpPost]
        public async Task<IActionResult> Create(InsertBusinessPictureCommand command, CancellationToken cancellation)
        {
            ...
            CancellationToken cancellation = default)
        {
            ...
            var pageModel = await _mediator.Send(new GetBusinessPictureQuery
            {
                Id = Id
            }, cancellation);
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(UpdateBusinessPictureCommand command, CancellationToken cancellation = default)
        {
            if (ModelState.IsValid)
            {
                var result = await _mediator.Send(command, cancellation);
         ...
         CancellationToken cancellation)
        {
            ...
            var requestModel = await _mediator.Send(new DeleteBusinessPictureCommand()
            {
                Id = model.Id
            }, cancellation);
